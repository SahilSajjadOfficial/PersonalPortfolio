    ...
    <section id="about" className="min-h-[500px] py-16 flex items-center">
      ...
      <div className='max-w-3xl w-full'>
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            I am actively expanding my expertise from Front-end Web Development into the full <span className="font-semibold text-blue-600">MERN stack</span>, incorporating technologies like Next.js and SQL databases. 
